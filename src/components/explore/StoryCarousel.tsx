      ...
      <div className="flex min-h-min flex-row items-start justify-start gap-4">
        <div className="flex flex-col justify-center items-center gap-2 w-20 text-center flex-shrink-0">
          <div className="relative">
            ...
            ></div>
            <div className="absolute bottom-0 right-0 bg-primary-app text-white rounded-full w-6 h-6 flex items-center justify-center border-2 border-background-dark">
              <span className="material-symbols-outlined !text-base">add</span>
            </div>
          </div>
          <p className="text-white text-[13px] font-medium leading-normal">Hikayen</p>
        </div>
        <div className="flex flex-col justify-center items-center gap-2 w-20 text-center flex-shrink-0">
          <div
            ...
            style={{
              backgroundImage: `url("https://lh3.googleusercontent.com/aida-public/AB6AXuAS-xAz124ZlwfYPlsOoSUpQwtPDjGBWkcqShn-8NdYwPmHQptDUCAEkztFQY8Je_1E5uGtItuKosyVQgfrB1Cv4rYUYZWdvvNs0qJGvv4M5Z7gDsB4i0gnzBVT4DEyt5m6PsBFpXuawUjuQv8kTG5Dwwd2wfHLJU99qWF19lbGhKTLfC4Aap2dat3oHE2w6oWZ8ZKvmMiEflDnpUaE-vAdKrhqak2-RCVCHpVUoLbytr_Y1cUcxHFdMhi3N5ZkhDLQGVIDiqGhBd8")`,
            }}
          ></div>
          <p className="text-white text-[13px] font-normal leading-normal">Elif</p>
        </div>
        <div className="flex flex-col justify-center items-center gap-2 w-20 text-center flex-shrink-0">
          <div
            className="w-16 h-16 bg-center bg-no-repeat aspect-square bg-cover rounded-full p-0.5 border-2 border-primary-app"
          ...
          ></div>
          <p className="text-white text-[13px] font-normal leading-normal">Ahmet</p>
        </div>
        <div className="flex flex-col justify-center items-center gap-2 w-20 text-center flex-shrink-0">
          <div
            className="w-16 h-16 bg-center bg-no-repeat aspect-square bg-cover rounded-full p-0.5 border-2 border-primary-app"
            ...
            style={{
              backgroundImage: `url("https://lh3.googleusercontent.com/aida-public/AB6AXuCNsFsiBhIqO2YTCcfwKwLVF6MjuVAkumdiei0g0P_MLJmEpW3WexMJs7oAXJMCGyfZu5_5BHn4OiQU7D9MiWo8IQgHLcTGzLnbLwfKrlYaEdyoancsCUvr-luz1rYX1_jMwmbVychHj0ucxSWPToJdNh1p7nj94Ft3wQxDHviY7TGGcY3NGY7v_MMRJPl0ZS9BMuXB2zRvNzSphl1ZIV79387E7zgoFJNMdTzJpy4TqeCFItcUOs9pErLGjye_ptrenv-ZIWkApYA")`,
            }}
          ></div>
          <p className="text-white text-[13px] font-normal leading-normal">Zeynep</p>
        </div>
        <div className="flex flex-col justify-center items-center gap-2 w-20 text-center flex-shrink-0">
          <div
            className="w-16 h-16 bg-center bg-no-repeat aspect-square bg-cover rounded-full p-0.5 border-2 border-primary-app"
        ...
        <div className="flex flex-col justify-center items-center gap-2 w-20 text-center flex-shrink-0">
          ...
          ></div>
          <p className="text-white text-[13px] font-normal leading-normal">Selin</p>
        </div>
      </div>
      <style>{`
