      ...
      <div className="flex items-center p-4 pb-2 justify-between gap-4"> {/* gap-4 eklendi */}
        ...
        <label className="flex flex-col min-w-40 h-12 flex-1"> {/* flex-1 ile tam genişlik */}
          <div className="flex w-full flex-1 items-stretch rounded-full h-full"> {/* rounded-full ile yuvarlatılmış köşeler */}
            ...
            <Input
              className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-r-full text-foreground focus:outline-0 focus:ring-0 border-none bg-card focus:border-none h-full placeholder:text-muted-foreground px-4 pl-2 text-base font-normal leading-normal"
