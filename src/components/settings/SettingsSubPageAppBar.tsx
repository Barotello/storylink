...
const SettingsSubPageAppBar: React.FC<SettingsSubPageAppBarProps> = ({ title }) => {
  ...
  return (
    <header className="flex items-center p-4 sticky top-0 z-10 bg-background/80 backdrop-blur-sm">
      <Button
        variant="ghost"
      ...
      <h1 className="flex-1 text-center text-xl font-bold leading-tight tracking-tight text-foreground">{title}</h1>
