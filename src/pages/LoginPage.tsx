            ...
            <div className="w-full max-w-md space-y-8 py-8 mt-10">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-stretch gap-3">
                        <Button onClick={handleGoogleLogin} className="flex min-w-[84px] cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-full h-12 px-5 bg-card text-foreground text-base font-bold leading-normal tracking-[0.015em] w-full border border-border shadow-sm hover:bg-card/90">
