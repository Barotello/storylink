  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col font-display text-foreground">
      ...
      <main className="flex-1 px-4 py-4 text-center pb-24">
        ...
        <p className="text-muted-foreground mt-2">Burada tüm bildirimlerinizi göreceksiniz.</p>
        {/* Örnek bildirimler eklenebilir */}
        <div className="mt-8 space-y-4">
          <div className="p-4 bg-card rounded-lg shadow-sm text-left">
            <p className="font-medium">Elif Kaya yeni bir film paylaştı.</p>
            <p className="text-sm text-muted-foreground">2 dakika önce</p>
          </div>
          <div className="p-4 bg-card rounded-lg shadow-sm text-left">
            <p className="font-medium">Mehmet Yılmaz gönderinizi beğendi.</p>
            <p className="text-sm text-muted-foreground">1 saat önce</p>
          </div>
        </div>
      </main>
    </div>
