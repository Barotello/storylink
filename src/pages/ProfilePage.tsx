...
const ProfilePage: React.FC<ProfilePageProps> = ({ isDrawer = false }) => {
  ...
  return (
    <div className="relative w-full flex flex-col group/design-root overflow-x-hidden font-display text-foreground">
      {!isDrawer && (
        <header className="sticky top-0 z-10 flex items-center bg-background/80 p-4 pb-2 backdrop-blur-sm justify-between">
          ...
          <Link to="/settings" className="flex size-10 shrink-0 items-center justify-center p-0">
            <Button variant="ghost" className="text-foreground p-0">
      ...
      <div className="relative w-full h-[60vh] sm:h-[70vh]">
        <img className="absolute inset-0 w-full h-full object-cover" data-alt="A smiling woman with brown hair looking over her shoulder." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBhchh8XKOBvLVWxmCWS5c_y0PfQeBS5WhgmYXE2vIuSnymS9N37M2ix1ei8H6spNwqq9wwLdDhof1HuO76ux5rqGvbd2F139s05f6g3KyR99BBoO12993l96oA7K0Icl6aVmNtZW-9yLoe1NuA3WZFlAymBE8Gmv08Slf3lq4BEH_MogeeLaLUAfv5lmVzsDrojkpbM9Hvc7usFsAdMeHLHYCH04NATdEKHb92eJ8LQiYes3_ZO60ltQzSgruj6e4WREdIYT363do"/>
        <div className="absolute inset-0 bg-gradient-to-t from-background via-background/50 to-transparent"></div>
        <div className="absolute top-4 right-4 z-10">
          <Button className="w-10 h-10 rounded-full bg-background/40 backdrop-blur-sm flex items-center justify-center text-foreground">
      ...
      <div className="p-5 -mt-20 relative z-10 space-y-6">
        ...
        <div className="bg-card/20 backdrop-blur-xl p-5 rounded-lg border border-border shadow-lg">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-foreground tracking-tight text-3xl font-bold leading-tight">Jessica, 29</h1>
              <p className="text-muted-foreground text-base font-normal leading-normal pt-1">İstanbul, Türkiye • UI/UX Tasarımcısı</p>
            </div>
        ...
        <div className="space-y-2">
          <h3 className="text-foreground text-lg font-bold leading-tight tracking-[-0.015em] px-1">Hakkında</h3>
          <p className="text-muted-foreground text-base font-normal leading-relaxed px-1">
        ...
        <div className="space-y-4">
          <h3 className="text-foreground text-lg font-bold leading-tight tracking-[-0.015em]">Favori Filmleri</h3>
          <div className="flex gap-4 overflow-x-auto pb-4 -mx-5 px-5" style={{ scrollbarWidth: "none", MsOverflowStyle: "none" }}>
            ...
            <div className="flex-shrink-0 w-32">
              ...
              <p className="text-foreground text-sm font-semibold mt-2 truncate">Yüzüklerin Efendisi</p>
            </div>
            <div className="flex-shrink-0 w-32">
              ...
              <p className="text-foreground text-sm font-semibold mt-2 truncate">The Dark Knight</p>
            </div>
            <div className="flex-shrink-0 w-32">
              <img className="w-full h-48 object-cover rounded-lg shadow-lg" data-alt="Parasite movie poster." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBvARva86Sx2Fl3cYo-gkekqmD7L5Jiztk947fsbgRp9AWmHcFa9TDbHAJhpoexJrlbP1R93lnaOnELaRgvqQstEnfkcswlXJ17O8aT9fzMuJyrlaKcLM1CKwx-7_cYnf_JaL0gZGYx9aucdJaRRe-lnqJDW5C2BuD1-esacjsv12rsUPdRMuXLNTloI_kQBzCYzeCqK7LLo9yIQEzpHMZsZkhDLQGVIDiqGhBd8"/>
              <p className="text-foreground text-sm font-semibold mt-2 truncate">Parasite</p>
            </div>
          </div>
        </div>
        {/* 5. Kitap Galerisi */}
        <div className="space-y-4">
          <h3 className="text-foreground text-lg font-bold leading-tight tracking-[-0.015em]">Favori Kitapları</h3>
          <div className="flex gap-4 overflow-x-auto pb-4 -mx-5 px-5" style={{ scrollbarWidth: "none", MsOverflowStyle: "none" }}>
            <div className="flex-shrink-0 w-32">
              ...
              <p className="text-foreground text-sm font-semibold mt-2 truncate">Açlık Oyunları</p>
            </div>
            <div className="flex-shrink-0 w-32">
              ...
              <p className="text-foreground text-sm font-semibold mt-2 truncate">1984</p>
            </div>
            {/* Ortak Zevk Vurgusu Örneği */}
            <div className="flex-shrink-0 w-32 relative">
              <div className="absolute -top-2 -right-2 z-10 w-8 h-8 rounded-full bg-profile-accent-red flex items-center justify-center">
              ...
              <p className="text-foreground text-sm font-semibold mt-2 truncate">Dune</p>
            </div>
            <div className="flex-shrink-0 w-32">
              ...
              <p className="text-foreground text-sm font-semibold mt-2 truncate">Otostopçunun Galaksi Rehberi</p>
            </div>
          </div>
        </div>
        {/* 6. Detaylı Bilgiler */}
        <div className="space-y-4">
          <h3 className="text-foreground text-lg font-bold leading-tight tracking-[-0.015em]">Detaylar</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div className="bg-card/50 p-3 rounded-lg flex items-center gap-3">
              <span className="material-symbols-outlined text-muted-foreground icon-outline">cake</span>
              <span className="text-foreground text-sm">Terazi</span>
            </div>
            <div className="bg-card/50 p-3 rounded-lg flex items-center gap-3">
              <span className="material-symbols-outlined text-muted-foreground icon-outline">school</span>
              <span className="text-foreground text-sm">Lisans</span>
            </div>
            <div className="bg-card/50 p-3 rounded-lg flex items-center gap-3">
              <span className="material-symbols-outlined text-muted-foreground icon-outline">music_note</span>
              <span className="text-foreground text-sm">Indie Rock</span>
            </div>
            <div className="bg-card/50 p-3 rounded-lg flex items-center gap-3">
              <span className="material-symbols-outlined text-muted-foreground icon-outline">sports_esports</span>
              <span className="text-foreground text-sm">Oyun</span>
            </div>
            <div className="bg-card/50 p-3 rounded-lg flex items-center gap-3">
              <span className="material-symbols-outlined text-muted-foreground icon-outline">flight</span>
              <span className="text-foreground text-sm">Seyahat</span>
            </div>
            <div className="bg-card/50 p-3 rounded-lg flex items-center gap-3">
              <span className="material-symbols-outlined text-muted-foreground icon-outline">local_bar</span>
              <span className="text-foreground text-sm">Bazen</span>
            </div>
          </div>
        </div>
      </div>
      {/* 7. Sabit Aksiyon Butonları (Sadece çekmece içinde göster) */}
      {isDrawer && (
        <div className="sticky bottom-0 left-0 right-0 bg-gradient-to-t from-background via-background to-transparent p-4 z-20">
          <div className="max-w-md mx-auto flex justify-around items-center gap-4 bg-background/80 backdrop-blur-lg p-3 rounded-full border border-border">
            <Button className="w-14 h-14 rounded-full bg-card/50 flex items-center justify-center text-muted-foreground hover:bg-card/70 transition-colors">
