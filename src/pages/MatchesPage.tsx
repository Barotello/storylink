...
const MatchesPage = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col group/design-root overflow-hidden bg-background-dark font-display text-text-dark">
      {/* Üst Bilgi Çubuğu (TopAppBar) */}
      <header className="flex items-center bg-background-dark p-4 pb-2 justify-between">
        ...
        <h1 className="text-white text-2xl font-bold leading-tight tracking-[-0.015em] flex-1">Encore</h1>
      ...
      <div className="flex gap-3 px-4 pb-4 overflow-x-auto">
        <div className="flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-chip-dark-bg pl-2 pr-4 opacity-60 cursor-not-allowed">
          <span className="material-symbols-outlined text-white" style={{ fontSize: "20px" }}>lock</span>
          <p className="text-white text-sm font-medium leading-normal">Konum</p>
        </div>
        <div className="flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-chip-dark-bg pl-2 pr-4">
          ...
          <p className="text-white text-sm font-medium leading-normal">Beğeni Kaldı: 10</p>
        </div>
      </div>
        ...
        <div className="@container">
          <div className="gap-4 px-4 grid-cols-[repeat(auto-fit,minmax(80px,_1fr))] grid">
            <div className="flex flex-col items-center gap-2 py-2.5 text-center">
              <Button className="rounded-full bg-chip-dark-bg p-4 flex items-center justify-center w-16 h-16">
                <span className="material-symbols-outlined text-white text-3xl">close</span>
              </Button>
              <p className="text-white text-sm font-medium leading-normal">Geç</p>
            </div>
            <div className="flex flex-col items-center gap-2 py-2.5 text-center">
              ...
              <p className="text-white text-sm font-medium leading-normal">Süper Beğeni</p>
            </div>
            <div className="flex flex-col items-center gap-2 py-2.5 text-center">
              ...
              <p className="text-white text-sm font-medium leading-normal">Beğen</p>
            </div>
          </div>
        </div>
      </div>
